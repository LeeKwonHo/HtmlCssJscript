...
<body>
	...
	<div>
		<span> <img class="menuImg" data-menu="cake" src="<c:url value='/images/starbucks/cake.jpg'/>">
		</span> <span> <img class="menuImg" data-menu="coffee" src="<c:url value='/images/starbucks/coffee.jpg'/>">
		</span> <span> <img class="menuImg" data-menu="sandwich" src="<c:url value='/images/starbucks/sandwich.jpg'/>">
		</span>
	</div>
	<div>
