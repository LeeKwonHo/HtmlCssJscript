...
<body>
	...
	<div>
		<h2>
			고객님 주문하신 <font style="font-size: 2.5em;"><c:out value="${menu }" /> <c:out value="${amount }" /></font> 개가 나왔습니다.
		</h2>
	</div>
	<div>
		<h3>
		...
		<c:forEach begin="1" end="${amount }" var="i" varStatus="s">
			<c:if test="${0 == i%10 }">
				...
				<span class="main_image">
					<img style="width: 70px; border: 5px solid red" src="<c:url value='/images/starbucks/${menu }.jpg'/>"> <font class="main_image_text" style="font-size: 20px">${i }</font>
				</span>
